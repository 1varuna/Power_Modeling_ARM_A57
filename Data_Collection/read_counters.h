...
Author: Varun Anand
Description:
    Uses inline assembly to read the PMU event count info from system registers.
...
//#define PMCR_D 0x00000002		// Set the enable bit on PMCR register
...
/* Save counter value after operation (post-count values) */
    ...
    //static int cnt0,cnt1,cnt2,cnt3,cnt4,cnt5,cycle_count;
    ...
    // Function to enable necessary counters 
    void init_counters()
    {
    ...
    */ 
    ...
    //cnt0 = (poc0);
    //printf("\t Counter 0 activity density for the given workload: %0d \n",cnt0);
    ...
    //cnt1 = (poc1);
    //printf("\t Counter 1 activity density for the given workload: %0d \n",cnt1);
    ...
    //cnt2 = (poc2);
    //printf("\t Counter 2 activity density for the given workload: %0d \n",cnt2);
    ...
    //cnt3 = (poc3);
    //printf("\t Counter 3 activity density for the given workload: %0d \n",cnt3);
    ...
    //cnt4 = (poc4);
    //printf("\t Counter 4 activity density for the given workload: %0d \n",cnt4);
    ...
    //cnt5 = (poc5);
    //printf("\t Counter 5 activity density for the given workload: %0d \n",cnt5);
...
void disable_counters()
{
    ...
    /* Set PM counter enable clear register 
    to disable countng on available external system registers
    */ 
    asm volatile("msr pmcntenclr_el0,%0" :: "r" (0x8000003f));
